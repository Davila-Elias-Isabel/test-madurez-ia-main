...
export const QUESTIONS: Question[] = [
  // EJE 1 — Talento y Capacidades
  {
    ...
    dimensionIcon: "🧠",
    text: "¿Tu organización tiene personal capacitado en Inteligencia Artificial?",
    options: [
      { id: "a", text: "No tenemos ningún personal con conocimientos en IA", score: 0 },
      { id: "b", text: "Algunos colaboradores tienen conocimiento autodidacta básico sobre IA", score: 1 },
      { id: "c", text: "Contamos con personal técnico con formación formal en IA", score: 2 },
